...
function Footer() {
  ...
  return (
    <div>
      <footer className="footer w-full p-5 md:p-10 font-semibold  bg-[#000] text-[#b9b4b4]">
        <div>
          {/* <svg
            width="50"
            height="50"
          ...
          <Image src='/media/main_logo1.png' height={100} width={100} alt="Incoming india" className="xl:ml-16 lg:ml-8 md:hidden" />
          <Image src='/media/main_logo1.png' height={140} width={140} alt="Incoming india" className="xl:ml-16 lg:ml-8 md:block hidden" />
        ...
        <div>
          ...
          <a className="link link-hover" href="/india">India</a>
          <a className="link link-hover" href="/bhutan">Bhutan</a>
          <a className="link link-hover" href="/nepal">Nepal</a>
          <a className="link link-hover" href="/lanka">Sri Lanka</a>
          <a className="link link-hover" href="/maldives">Maldives</a>
        </div>
        <div>
          <span className="footer-title text-[#ffffff]">Quick Links</span>
          <a className="link link-hover" href="/">Home</a>
          {/* <a className="link link-hover">Destinations</a> */}
          <a className="link link-hover" href="/experiences">Experiences</a>
