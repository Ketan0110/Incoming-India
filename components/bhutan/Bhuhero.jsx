    ...
    return (
        <section id="nephero" className="bg-center bg-cover bg-no-repeat sm:h-[100vh] h-[60vh]" style={mystyle}>
            ...
            <div className="h-screen bg-black/40 flex justify-center items-center relative px-3">
                ...
                <div>
                    <h1 className="text-4xl md:text-6xl text-white font-semibold font-poppins  tracking-wide hero-shadow text-center">BHUTAN</h1>
                    <p className="md:text-2xl text-xl text-center tracking-wide hero-shadow text-white font-poppins font-semibold">the land of the thunder dragon and spiritual serenity.</p>
                </div>
