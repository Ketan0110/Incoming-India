                    ...
                    <div className='w-full sm:w-[35%] md:w-[25%] flex items-center md:justify-start justify-center'>
                        ...
                        <div>
                            <div className='grid-cols-2 grid sm:block'>
                                <div className={`text-center px-5 md:py-1 cursor-pointer  text-base md:text-xl ${hill ? 'border-b-2 border-b-orange-500 text-orange-500' : ''}`} onClick={() => { setHill(true), setEast(false), setCultural(false), setSouth(false), setWestcol(false) }}>Hilly Region</div>
