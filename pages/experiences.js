                    ...
                    <div style={itemstyle2} className="h-[50vh] bg-blue-300   bg-cover bg-center bg-no-repeat" id='mountains'>
                        <div className="flex-row-reverse md:flex">
                            ...
                            <div className="w-full md:w-1/2 px-2 ">
                                ...
                                <p className="classNametext-lg md:text-lg md:px-10 px-2 pb-5">
                    ...
                    <div style={itemstyle2} className="h-[50vh] bg-blue-300   bg-cover bg-center bg-no-repeat" id='forts-temples'>
                        <div className="flex-row md:flex">
                            ...
                            <div className="w-full md:w-1/2 px-2 ">
                                ...
                                <p className="classNametext-lg md:text-lg md:px-10 px-2 pb-5">
                                    India's rich cultural heritage is reflected in its magnificent forts, palaces, temples, and Mughal architecture. Each era has left a unique architectural legacy. The majestic forts of Rajasthan, palaces of Udaipur, Jodhpur, and Hyderabad showcase the opulence of the erstwhile royalty. The Mughal architecture of the famous Taj Mahal showcases the beauty of Islamic art, blending seamlessly with Indian elements. The temples of South India showcase the rich Dravidian architecture and intricate carvings. The forts, palaces, temples, and Mughal architecture of India provide a glimpse into the country's glorious past and are a visual treat for anyone interested in history and architecture.                                </p>
